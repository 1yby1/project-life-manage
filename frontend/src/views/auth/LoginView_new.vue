<template>
  <div class="login-wrap">
    <el-card class="login-card" shadow="hover">
      ...
      <el-alert
        title="演示说明"
        description="支持"后端登录"和"演示角色登录"两种方式。"
        type="info"
        :closable="false"
        show-icon
      ...
      <el-form v-if="useDemo" label-width="80px" label-position="top">
      ...
      <el-form v-else label-width="80px" label-position="top">
...
import { User, Lock, Check, HomeFilled } from '@element-plus/icons-vue'
